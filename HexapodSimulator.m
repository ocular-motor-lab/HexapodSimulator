...
%                 plot3(app.UIAxes,aizero(1,[end 1:end]), aizero(2,[end 1:end]), aizero(3,[end 1:end]))
%                 scatter3(app.UIAxes,aizero(1,:), aizero(2,:), aizero(3,:))
                ...
                for i=1:6
                    ...
                    lzero = biw + (ai - biw).*zeroLengths./currentLengths;
